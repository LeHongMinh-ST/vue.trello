  ...
  <div class="window-sidebar">
    <div class="window-module u-clearfix">
      ...
      <div class="u-clearfix">
        <a class="button-link js-edit-labels" href="#" title="Nhãn">
          <span class="icon-sm icon-label"><i class="el-icon-price-tag"></i></span>
          <span class="js-sidebar-action-text">Nhãn</span>
        </a>
        <a class="button-link js-add-checklist-menu" href="#" title="Việc cần làm">
        ...
        <a class="button-link js-add-checklist-menu" href="#"
           title="Việc cần làm">
